        ...
        <Paper elevation={3} sx={{ padding: 2, marginBottom: 3, minHeight: "80vh", backgroundColor: "#f9f9f9", borderRadius: "12px" }}>
          ...
          <Grid container spacing={2}>
            {partidos.length > 0 ? (
                    ...
                    <Paper elevation={2} sx={{ display: "flex", width: "100%" }}>
                      <Box sx={{ flex: 9 }}>
                        <Link to={`/detallesPartido/${partido.id}`} style={{ textDecoration: "none" }}>
                          <Card sx={{ position: "relative", backgroundColor: "#f7fafc", borderRadius: "12px 0 0 12px", height: "100%", transition: "all 0.3s ease", "&:hover": { boxShadow: 6, transform: "scale(1.02)" } }}>
                            <CardContent>
                            ...
                            return (
                              <>
                                <Tooltip title="Aceptar designación" arrow placement="right">
                                  <span>
                                    <IconButton aria-label="Aceptar designación" onClick={() => handleOpenDialog(partido.id, 1)} sx={{ backgroundColor: "#4CAF50", color: "white", "&:hover": { backgroundColor: "#45a049" } }}>
                                      <CheckIcon />
                                    </IconButton>
                                  </span>
                                </Tooltip>
                                <Tooltip title="Rechazar designación" arrow placement="right">
                                  <span>
                                    <IconButton aria-label="Rechazar designación" onClick={() => handleOpenDialog(partido.id, 2)} sx={{ backgroundColor: "#F44336", color: "white", "&:hover": { backgroundColor: "#e53935" } }}>
                                      <CloseIcon />
                                    </IconButton>
                                  </span>
                                </Tooltip>
              ...
              <Box sx={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", width: "100%", marginTop: "10%", padding: 4 }}>
                <img src="/notFoundIcon.png" alt="No designaciones" style={{ maxWidth: "200px", marginBottom: "16px", opacity: 0.7 }} />
